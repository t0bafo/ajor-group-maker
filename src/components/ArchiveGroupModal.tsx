...
const ArchiveGroupModal = ({ open, onOpenChange, groupName, onConfirm }: ArchiveGroupModalProps) => {
  return (
        ...
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex-1">
              <DialogTitle>Archive This Ajor?</DialogTitle>
            </div>
          </div>
          <DialogDescription className="space-y-3 pt-2">
            <p>
              You are about to archive <strong>{groupName}</strong>.
            </p>
            ...
            <p className="text-muted-foreground">
              This action can be reversed by unarchiving the group later.
            </p>
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
